...
const spinLoopHint = @import("../system.zig").spinLoopHint;
...
pub const Signal = extern struct {
    ...
    pub fn tryWait(self: *Signal, deadline: u64) !void {
        return self.tryWaitUntil(deadline);
    }

    fn tryWaitUntil(self: *Signal, deadline: ?u64) !void {
