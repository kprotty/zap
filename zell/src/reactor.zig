...
pub const Reactor = struct {
    ...
    pub const ConnectError = zio.Socket.RawConnectError;
    ...
    pub const AcceptError = zio.Socket.RawAcceptERror;
    ...
    pub const ReadError = zio.Socket.RawDataError;
    ...
    pub const WriteError = zio.Socket.RawDataError;
